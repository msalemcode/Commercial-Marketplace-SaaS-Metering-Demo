    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var config = new SaaSApiClientConfiguration()
            {
                ...
                SubscriptionKey= this.Configuration["SaaSApiConfiguration:SubscriptionKey"],
                OcrEndPoint = this.Configuration["SaaSApiConfiguration:OcrEndPoint"],
                MeteredEndPoint = this.Configuration["SaaSApiConfiguration:MeteredEndPoint"]
